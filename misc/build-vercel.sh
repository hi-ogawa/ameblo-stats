...
NODE_ENV=production BUILD_SERVER=./app/index-vercel.ts npx remix build

# run esbuild again manually to bundle server app
npx esbuild build/remix/production/server/index.js --outfile=build/remix/production/server/index-bundled.js --bundle --platform=node
